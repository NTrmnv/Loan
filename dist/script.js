...
function (_Slider) {
  ...
  _createClass(MiniSlider, [{
    ...
    value: function autoplaySlides() {
      ...
      var slidesField = document.querySelector('.modules__content-slider'),
          btnNext = document.querySelector('.slick-next'),
          btnPrev = document.querySelector('.slick-prev');
      slidesField.addEventListener('mouseenter', function () {
        clearInterval(autoplay);
      });
      slidesField.addEventListener('mouseleave', function () {
